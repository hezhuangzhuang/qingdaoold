...
public class ChatBeanLM {
    ...
    public ChatBeanLM(int type, String name, Date time, String textContent) {
        this.type = type;
        this.name = name;
        this.time = time;
    ...
    public ChatBeanLM(int type, String name, Date time, String textContent, String duration) {
        this.type = type;
        this.name = name;
        this.time = time;
        this.textContent = textContent;
    ...
    public ChatBean toChatBean() {
        return new ChatBean(id, type, name, time, textContent, duration, sendId, sendName, receiveId, receiveName, isSend, isRead, conversationId, conversationUserName, isGroup);
    }

    @Generated(hash = 65603084)
    public ChatBeanLM(Long id, int type, String name, Date time, String textContent, String duration, String sendId, String sendName, String receiveId, String receiveName,
