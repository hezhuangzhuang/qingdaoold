...
import static com.zxwl.commonlibrary.utils.SystemBarHelper.getStatusBarHeight;
...
public class UIUtils {
    ...
    public static void GetInfo(Context context) {
        ...
        Log.d(Constant.TAG, "screenWidth=" + screenWidth + " screenHeight=" + screenHeight + " density=" + density);
    }
