package com.zxwl.frame.utils.permisson;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(App.getInstance().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(App.getInstance(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(App.getInstance());
    }
    ...
    public static void requestWriteSettings(final SimpleCallback callback) {
        ...
        PermissionActivity.start(App.getInstance(), PermissionActivity.TYPE_WRITE_SETTINGS);
    }
    ...
    public static boolean isGrantedDrawOverlays() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            AppOpsManager aom = (AppOpsManager) App.getInstance().getSystemService(Context.APP_OPS_SERVICE);
            if (aom == null) {
                return false;
            }
    ...
    public static void requestDrawOverlays(final SimpleCallback callback) {
        ...
        PermissionActivity.start(App.getInstance(), PermissionActivity.TYPE_DRAW_OVERLAYS);
    }
...
//            e.printStackTrace();
    ...
    private static void gotoMiuiPermission() {
        try { // MIUI 8
            ...
            localIntent.putExtra("extra_pkgname", App.getInstance().getPackageName());
            localIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            App.getInstance().startActivity(localIntent);
        } catch (Exception e) {
            try { // MIUI 5/6/7
                Intent localIntent = new Intent("miui.intent.action.APP_PERM_EDITOR");
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(App.getInstance(), PermissionActivity.TYPE_RUNTIME);
    }
