...
public class NotificationUtils {
    ...
    public static void notify(String tag,
                              ...
                              Func1<Void, NotificationCompat.Builder> func1) {
        //点亮屏幕
        ...
        NotificationManagerCompat nmc = NotificationManagerCompat.from(App.getInstance());
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(App.getInstance()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(App.getInstance()).cancel(id);
    }
    ...
    public static class ChannelConfig {
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                App.getInstance().getPackageName(), App.getInstance().getPackageName(), IMPORTANCE_DEFAULT
        );
