...
public class BannerView extends RelativeLayout implements BannerAdapter.ViewPagerOnItemClickListener {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        viewPager = inflate.findViewById(R.id.layout_banner_viewpager);
        points = inflate.findViewById(R.id.layout_banner_points_group);
    ...
    public void build(List<BannerEntity> list) {
        ...
        for (int i = 0; i < bannerList.size(); i++) {
            GlideImageView mImageView = new GlideImageView(getContext());
            LayoutParams layoutParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
            mImageView.setLayoutParams(layoutParams);
//            Glide.with(getContext())
//                    .load(bannerList.get(i).img)
//                    .into(mImageView);
            mImageView.centerCrop()
                    .error(R.mipmap.image_load_err)
                    .load(bannerList.get(i).img, R.color.placeholder);
    ...
    public void onItemClick() {
        Toast.makeText(getContext(), "" + currentPos, Toast.LENGTH_SHORT);
