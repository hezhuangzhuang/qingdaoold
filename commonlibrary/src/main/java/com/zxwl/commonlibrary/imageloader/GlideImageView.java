package com.zxwl.commonlibrary.imageloader;
...
import com.zxwl.commonlibrary.imageloader.transformation.CircleTransformation;
import com.zxwl.commonlibrary.imageloader.transformation.RadiusTransformation;
...
public class GlideImageView extends ImageView {
    ...
    public GlideImageView centerCrop() {
        getImageLoader().getGlideRequest().apply(new RequestOptions().centerCrop());
        return this;
    }

    public GlideImageView fitCenter() {
        getImageLoader().getGlideRequest().apply(new RequestOptions().fitCenter());
        return this;
    }

    public GlideImageView diskCacheStrategy(@NonNull DiskCacheStrategy strategy) {
        getImageLoader().getGlideRequest().apply(new RequestOptions().diskCacheStrategy(strategy));
        return this;
    }

    public GlideImageView placeholder(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().apply(new RequestOptions().placeholder(resId));
        return this;
    }

    public GlideImageView error(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().apply(new RequestOptions().error(resId));
        return this;
    }

    public GlideImageView fallback(@DrawableRes int resId) {
        getImageLoader().getGlideRequest().apply(new RequestOptions().fallback(resId));
        return this;
    }

    public GlideImageView dontAnimate() {
        getImageLoader().getGlideRequest().apply(new RequestOptions().dontTransform());
        return this;
    }
