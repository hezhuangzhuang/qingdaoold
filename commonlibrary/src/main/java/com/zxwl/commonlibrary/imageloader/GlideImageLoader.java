...
import com.zxwl.commonlibrary.imageloader.progress.ProgressManager;
...
public class GlideImageLoader {
    ...
    public RequestBuilder<Drawable> getGlideRequest() {
    ...
    public static void setAutoSizeIMG(Activity activity, String url, final ImageView imageView, final int width) {
        Glide.with(activity)
                .load(url)
                .into(new SimpleTarget<Drawable>() {
                    ...
                    public void onResourceReady(Drawable resource, Transition<? super Drawable> transition) {
                        ...
                        lp.width = width;
                        lp.height = (resource.getIntrinsicHeight() / resource.getIntrinsicWidth()) * lp.width;
